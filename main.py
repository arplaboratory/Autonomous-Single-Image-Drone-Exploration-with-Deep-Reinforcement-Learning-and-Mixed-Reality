if __name__ == '__main__':
    ...
    # NYU
    #from model_1CA import IMPALA_Net            # BEST
    #from model_1CA_ablation import IMPALA_Net   # MODEL ABLATION NO MAPS
    from model_1CA_baseline_nyu import IMPALA_Net  # MODEL BASELINE
    ...
    if IMPALA:
        ...
        if TEST_LAB:
            ...
            f = open('settings/IMPALA/settings.json')  # TRAIN
    ...
    if not eval_mode:
        ...
        #gnet.load_state_dict(torch.load('C:\\Users\\Idra\\Documents\\ActiveTracking\\NYU_models\\ablation\\no_maps.pt'))
        #gnet.load_state_dict(torch.load('C:\\Users\\Idra\\Documents\\ActiveTracking\\NYU_models\\salvati\\first_model_in_lab.pt'))
        #gnet.load_state_dict(torch.load('C:\\Users\\Idra\\Documents\\ActiveTracking\\NYU_models\\salvati\\first_model_right_left.pt'))  # BEST
        #gnet.load_state_dict(torch.load('C:\\Users\\Idra\\Documents\\ActiveTracking\\NYU_models\\symmetric\\best_model_6.pt'))
        gnet.load_state_dict(torch.load('C:\\Users\\Idra\\Documents\\ActiveTracking\\NYU_models\\baseline\\baseline_best_3.pt'))
